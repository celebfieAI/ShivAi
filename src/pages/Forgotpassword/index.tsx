  ...
  const handlePasswordReset = () => {
    sendPasswordResetEmail(auth, email)
      .then(() => {
        ...
        setEmail(""); // Assuming you have a setEmail function
      })
      .catch((error) => {
        Toastify({
      ...
      <div className="container grid lg:h-screen grid-cols-12 lg:max-w-[1550px] 2xl:max-w-[1750px] py-10 px-5 sm:py-14 sm:px-10 md:px-36 lg:py-0 lg:pl-14 lg:pr-12 xl:px-24">
        ...
        >
          <div className="relative z-10 flex flex-col justify-center w-full h-full py-2 lg:py-32">
            <div className="rounded-[0.8rem] w-[355px] h-[155px] border border-primary/30 flex items-center justify-center">
            ...
            <div className="mt-10">
              ...
              <div className="mt-6">
               ...
               <Button
                    variant="primary"
                    rounded
                    className="mt-4 bg-gradient-to-r from-theme-1/70 to-theme-2/70 w-full py-3.5 xl:mr-3"
