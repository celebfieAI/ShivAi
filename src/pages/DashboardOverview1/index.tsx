  ...
  return (
    <div className="grid grid-cols-12 gap-y-10 gap-x-6">
          ...
          <Menu className="absolute top-0 right-0 mt-5 mr-5">
            ...
            <div className="flex flex-col items-center justify-around h-full">
              ...
              <div className="ml-0.5 h-full flex flex-col justify-evenly">
                ...
                <div className="text-3xl">+688%</div>
              </div>
            </div>
          </div>
      ...
      <div className="col-span-12">
       ...
       <div className="flex flex-col p-5 box box--stacked md:w-[32%] w-full">
              <PreviewComponent>
                {({ toggle }) => (
                  <>
        ...
        <div className="flex flex-col box box--stacked md:w-[32%] w-full">
